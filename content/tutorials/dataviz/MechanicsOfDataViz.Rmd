...
Just keep in mind that _luminance_ and _chroma_ -- how light a color is and how vibrant it is -- are _ordered values_, while _hue_ (or shade of color) is _unordered_ This becomes relevant when dealing with categorical data. For instance, moving back to the scatterplot we started with:
